...
{
    //params.setParam("AnalyzeSimulationOnly", "TRUE");
    ...
    myfile << "Writing this to a file a set of parameters.\n";
    ...
    myfile << infilename << " \n";
    //om
    // myfile<< "could not open input file!" << " \n";
        ...
        for (int rt = 0; rt < readparallel; rt++)
        {
            ...
            for (int f = 0; f < NFilePerRead; f++)
            {
                ...
                if (rt == 0 && f == 0)
                {
                    ...
                    myfile << "    Type 0 (gas):   " << nparttotal[0] << endl;
                ...
                for (int itype = 0; itype < ptypes; itype++)
                {
                    ...
                    if (params.find<bool>("AnalyzeSimulationOnly") && ptype_found >= 0) {
                        type = ptype_found;
                        myfile << "    new part   " << npartthis[type] << endl;
                    }
